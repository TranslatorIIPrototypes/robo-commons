...
def test_cc_to_gene(quickgo):
    r = quickgo.go_term_to_gene_annotation(KNode("GO:0005739", type = node_types.CELLULAR_COMPONENT))
    for e, k in r:
        assert k.type == node_types.GENE
    assert len(r) > 25
