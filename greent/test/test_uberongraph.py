...
def xtest_molecular_function_to_chemical(uberon):
...
def xtest_phenotype_to_biological_process_or_activity(uberon):
...
def xtest_disease_to_anatomy(uberon):
...
def xtest_cell_component_to_chemical(uberon):
